...
* The original package name 'com.narendra.microservices.Soring-cloud-config-server' is invalid and this project uses 'com.narendra.microservices.Soringcloudconfigserver' instead.
